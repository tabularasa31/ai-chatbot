...
1. Remove contradiction adjudication tenant override.
   ...
   - Delete `CONTRADICTION_ADJUDICATION_SETTINGS_KEY` from
     `backend/search/reliability.py` if no other code still uses it.
