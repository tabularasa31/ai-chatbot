"""Read-side gap summary builder (active counts, coverage classification)."""
...
def get_gap_summary(db: Session, *, tenant_id: UUID) -> GapSummaryResponse:
