...
- Таблица `user_sessions` создана под **v2** (кросс-сессии); логика заполнения — позже.
...
**Backlog (будущие фазы):** блоклист тем с редиректом, preview/simulation, разные уровни по сегментам (при появлении стабильного `audience_tag` во всех каналах).
