...
- if the retrieval confidence is too low, the bot may ask one short follow-up question (at most once per conversation)
- if still unsure after clarification, the bot escalates to your support team
