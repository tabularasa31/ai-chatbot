...
| `backend/search/pipeline.py` | Hybrid RAG retrieval pipeline (pgvector + BM25 + RRF); collaborators split across `backend/search/{reliability,types,query_variants,bm25,fusion,embedding,retrieval_db}.py` |
