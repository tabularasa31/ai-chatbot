...
def build_rag_prompt(
    ...
    *,
    ...
    system_rules = (
        ...
        # Production shape these two close: the prompt said what may be
        # said and how long, never how it should sound, so every reply
        # opened on a summary header naming the documentation.
        "- Sound like a support person typing a reply, not like a generated report. Open with the answer itself: no summary header in front of it, no restatement of the question, and no sentence framing where the answer comes from. That you answer from the documentation, from the retrieved context, or within the product's scope is a constraint on you, not information for the user — the UI shows the sources beside your reply.\n"
