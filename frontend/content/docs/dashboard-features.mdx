...
- **Clarification visibility:** if the bot asked a follow-up question, you can see that turn in the conversation instead of guessing why the bot paused before answering.
...
- Clarification-aware debug metadata shows the decision the bot would make for the turn (direct answer, answer with caveat, blocking or inline clarifying question, or escalation).
