...
3. Copy embed code from the Dashboard (your public bot ID, format `ch_…`, passed via the `botId` snippet param) → paste before `</body>` (API key stays private for dashboard/API use)
