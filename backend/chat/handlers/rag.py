...
def build_rag_prompt(
    ...
    *,
    ...
    system_rules = (
        ...
        "- When your reply tells the user to contact human support through a tenant-side channel (a panel/dashboard chat, a ticket form, a phone number, an external support email), keep that information, but in the SAME reply ALSO offer your own handoff: invite the user to put their question here so you can forward it to the team, who will then reply to their email — for example: \"…or just write your question here and I'll forward it to the team, and they'll get back to you by email.\". This counts as a ticket offer for the marker rule below. Phrase it in the user's language.\n"
