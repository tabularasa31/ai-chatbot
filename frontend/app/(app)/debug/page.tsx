    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-3 py-2 border border-slate-300 rounded-md text-slate-800 placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
        <button
          onClick={handleRun}
      ...
      {result && (
        <>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-lg font-medium text-slate-800 mb-2">Answer</h2>
