...
| Guards | `GUARDS_MODEL`, `RELEVANCE_GUARD_MODEL`, `INJECTION_SEMANTIC_THRESHOLD`, `INJECTION_SEMANTIC_TIMEOUT_SEC`, `INJECTION_SEMANTIC_ENABLED`, `RELEVANCE_RETRIEVAL_THRESHOLD`, `RERANKER_BYPASS_THRESHOLD` |
