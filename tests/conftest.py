...
def mock_openai_client():
    ...
    with patch("backend.embeddings.service.get_openai_client", return_value=mock_client, create=True), \
         ...
         patch("backend.core.embeddings.get_openai_client", return_value=mock_client), \
         patch("backend.core.embeddings.get_async_openai_client", return_value=async_mock_client), \
