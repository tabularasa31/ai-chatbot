...
| `apiBase` | `https://getchat9.live` | Chat9 API origin. You normally do **not** set this — the default already points at our production. Used internally for staging/dev. |
