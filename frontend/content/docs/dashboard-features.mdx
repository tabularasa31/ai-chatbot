...
- **Embed code** — HTML snippet that loads the widget loader (`widget.getchat9.live/widget.js`) and passes your bot's `public_id` via the `data-bot-id` attribute. Copy the block; code areas use an inline **copy** icon.
