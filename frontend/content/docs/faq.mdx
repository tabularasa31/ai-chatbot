...
Yes. If the retrieval confidence is too low to give a reliable answer, Chat9 may ask one short clarification question instead of guessing. When possible, the widget can show answer options as quick replies. The bot asks at most one clarifying question per conversation — after that it either gives a best-effort answer with a caveat or escalates to your support team.
